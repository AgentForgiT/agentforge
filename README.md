...
Genesis Sprint 18 adds structured access logging to the gateway so operators can observe request traffic, status, and timing through a configurable, privacy-safe log level.
